...
const DPartsApproved = () => {
    ...
    { field: "id", headerName: "ID", width: 70 },
    {
      ...
      renderCell: (param) => (
        <span
          ...
          onClick={() => {
            const shyam2 = allUsers.find((itm) => itm.id === param.row.id);

            outletContext.setActiveTab(48);
            outletContext.setOutbound(shyam2);
          }}
        >
    ...
    const getParts = async () => {
      try {
        const response = await getAPI(
          `${apiEndpoints.getInvoicesByStatusParts}approved`
        );
  ...
  return (
    <div className="mt-3">
      <h3>Parts Outbound Domestic Approved</h3>
