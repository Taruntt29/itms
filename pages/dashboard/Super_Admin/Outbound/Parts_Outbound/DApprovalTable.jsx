...
const DApprovalTable = () => {
  const [outletContext] = useOutletContext();
  const shyam1 = outletContext.outbound;

  const customRow = [
    {
      id: shyam1.id,
      Invoice: shyam1.invoiceNum,
      Machine: shyam1?.items[0]?.machineNo ?? "",
      date: shyam1.invoiceDate ?? "",
      M3Freight: shyam1?.lrNumber,
      challan: shyam1?.m3TransportCharge,
    },
  ];
  ...
  useEffect(() => {
    const docNumber = shyam1.transporterDocNo;
  ...
  const onSubmitHandler = async () => {
    try {
      const updateData = {
        ...
        Machine: shyam1?.items[0]?.machineNo ?? "",
        date: shyam1.invoiceDate ?? "",
        lrNumber: shyam1?.lrNumber,
        m3TransportCharge: shyam1?.m3TransportCharge,
      };
