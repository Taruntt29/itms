    ...
    },
    {
      ...
      renderCell: (param) => (
        <span
          ...
          onClick={() => {
            const tiwari = allUsers.find((itm) => itm.id === param.row.id);

            outletContext.setActiveTab(35);
            outletContext.setOutbound(tiwari);
          }}
        >
    ...
    const getDomestic = async () => {
      try {
        const response = await getAPI(
          `${apiEndpoints.getInvoicesByStatusDomestic}approved`
        );
  ...
  return (
    <div className="mt-3 ">
      <div className="d-flex justify-content-between">
        <h3>Machine Outbound Domestic Approved</h3>
...
export default DomesticMachineApproved;
