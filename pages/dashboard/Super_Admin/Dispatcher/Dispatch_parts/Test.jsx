...
import InvoiceLogoImage from "../../../../../assets/images/manitouLogo.jpg";
const jsxToPDF = (parcelData, fileName) => {
  const jsxContent = (
                        ...
                        {_el?.items?.map((parcelDetailsInfo, ind) => {
                          return (
                            <tr key={ind + _ind}>
                              ...
                              <td>{parcelDetailsInfo.parcelPac}</td>
  ...
  element.href = `data:application/pdf;base64,${btoa(pdfContent)}`;
